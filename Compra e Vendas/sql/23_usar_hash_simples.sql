-- ============================================================================
-- Usar hash MD5 simples em vez de bcrypt (para testes)
-- ============================================================================

-- Recriar função criar_usuario usando MD5
...
DECLARE
  ...
  v_senha_hash TEXT;
BEGIN
  -- Gerar hash da senha usando MD5 (simples mas funcional)
...
-- Recriar função autenticar_usuario usando MD5
...
-- Verificação
SELECT 'Funções atualizadas para usar MD5!' as status;
