...
import { Building2, Users, Plus, Trash2, Save, CheckCircle, Home, Lock, Unlock, AlertCircle } from 'lucide-react';
            ...
            {formData.bloco_uid && apartamentos.length > 0 && (
              <div className="mt-4 bg-white dark:bg-gray-800 rounded-lg border border-gray-200 dark:border-gray-700 overflow-hidden">
                ...
                <div className="mt-4 px-4">
                  ...
                  <div className="relative overflow-auto max-h-80 bg-gradient-to-br from-gray-50 to-gray-100 dark:from-gray-800 dark:to-gray-900 rounded-lg p-4 border-2 border-gray-200 dark:border-gray-700 shadow-inner">
                    <div className="grid grid-cols-5 sm:grid-cols-8 md:grid-cols-10 lg:grid-cols-12 xl:grid-cols-15 gap-2">
                      {(formData.andar 
                        ...
                        <div
                          ...
                          className={`
                            ...
                            ${apt.ocupado === true 
                              ...
                              : 'bg-gradient-to-br from-green-500 to-green-600 text-white hover:from-green-600 hover:to-green-700 shadow-md hover:shadow-lg'
                            }
                            ${formData.apartamento_uid === apt.uid 
                              ? 'ring-4 ring-blue-500 ring-offset-2 scale-110 shadow-2xl z-10' 
                              : 'hover:scale-105'
                            }
                          `}
                        ...
                        >
                          ...
                          {apt.ocupado === true && (
                            <div className="absolute -top-1.5 -right-1.5 w-5 h-5 bg-white rounded-full flex items-center justify-center shadow-lg border border-red-200">
                  ...
                  <div className="mt-3 mx-4 flex items-start gap-2 text-xs text-gray-500 dark:text-gray-400 bg-blue-50 dark:bg-blue-900/20 p-2 rounded">
                    <span className="text-blue-600 dark:text-blue-400">💡</span>
                    <span>Role para ver todos os apartamentos. Clique para selecionar.</span>
                  </div>
                </div>
              </div>
            )}
          ...
          <Card className="p-4 sm:p-5 md:p-6 mb-4 sm:mb-6 dark:bg-gray-800 shadow-md">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-600 flex justify-end gap-3">
              <Button
                ...
                className="px-6 py-2.5 bg-gray-100 hover:bg-gray-200 dark:bg-gray-700 dark:hover:bg-gray-600 text-gray-700 dark:text-gray-300 font-semibold rounded-lg transition-all flex items-center gap-2"
              >
