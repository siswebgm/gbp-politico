...
interface PessoaDetailsModalProps {
  eleitor: Eleitor | null;
  isOpen: boolean;
  onClose: () => void;
}

export function PessoaDetailsModal({ eleitor, isOpen, onClose }: PessoaDetailsModalProps) {
  ...
  return (
    <Dialog open={isOpen} onOpenChange={onClose}>
      <DialogContent className="max-w-3xl">
        <DialogHeader>
          <DialogTitle className="text-2xl font-bold">Detalhes da Pessoa</DialogTitle>
        </DialogHeader>
